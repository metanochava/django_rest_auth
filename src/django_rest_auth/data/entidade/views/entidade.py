...
from django_rest_auth.data.entidade.serializers.entidade_gravar import EntidadeGravarSerializer
from django_rest_auth.data.entidade.serializers.entidade_user import EntidadeUserSerializer
