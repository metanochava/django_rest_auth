...
DEFAULT_TEMPLATES = {
    'REGISTER_CONFIRM': 'django_rest_auth/email_confirmacao.html',
    'PASSWORD_RESET': 'django_rest_auth/email_reset.html',
    'GENERIC_RESET': 'django_rest_auth/email_template_reset.html',
}
